      ...
      <div className="container mx-auto flex items-center justify-between px-4 py-4">
        <div className="flex items-center">
          ...
          <nav className="hidden md:flex space-x-4">
            ...
            <Link href="/" className="text-white hover:text-gray-300">TV Shows</Link>
            <Link href="/" className="text-white hover:text-gray-300">Movies</Link>
            <Link href="/" className="text-white hover:text-gray-300">New & Popular</Link>
          </nav>
        </div>
